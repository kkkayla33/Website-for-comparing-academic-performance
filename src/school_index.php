<?Php
    ...
    $stmt=$dbcon->prepare("SELECT `School`.`title`,AVG(`h_index`) as h_index, AVG(`i10_index`) as i_index
...
?>
    ...
    <div class="row justify-content-around">
                ...
                <nav class="nav nav-pills flex-column">
                    <a class="nav-link" href="#" role="tab">
                        ...
                        <nav class="nav nav-pills flex-column">
                            ...
                            <a class="nav-link ml-3 my-1 active" id="b-tab" href="school_index.php" role="tab"
        ...
        <div class="col-md-9">
            <div class="jumbotron">
                <h3>h Index & i10 Index Comparison By School </h1>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <br> 
                            <?php
                            $sql = "SELECT `School`.`title`,AVG(`h_index`) as h_index, AVG(`i10_index`) as i_index
                            FROM Faculty,`Faculty-School`,School
                            WHERE `Faculty`.`f_id` = `Faculty-School`.`f-id`
                                  AND `School`.`s-id` = `Faculty-School`.`s-id`
                            GROUP BY `Faculty-School`.`s-id`";
