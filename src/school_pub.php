<?Php
    ...
    $stmt=$dbcon->prepare("SELECT `School`.`title`,AVG(`first_pub`) as avg_pub, MIN(`first_pub`) as min_pub
...
?>
    ...
    <div class="row justify-content-around">
            ...
            <nav class="navbar navbar-light bg-light sticky-top">
                <nav class="nav nav-pills flex-column">
                    <a class="nav-link" href="#" role="tab">
                        ...
                        <nav class="nav nav-pills flex-column">
                            <a class="nav-link ml-3 my-1" id="a-tab" href="school_cit.php" role="tab"
                            ...
                            <a class="nav-link ml-3 my-1 active" id="b-tab" href="school_pub.php" role="tab"
        ...
        <div class="col-md-9">
            <div class="jumbotron">
                <h3>First Publish Year Comparison By School </h1>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <br>
                            ...
                            <br> 
                            <?php
                            $sql = "SELECT `School`.`title`,AVG(`first_pub`) as avg_pub, MIN(`first_pub`) as min_pub
                            FROM Faculty,`Faculty-School`,School
                            WHERE `Faculty`.`f_id` = `Faculty-School`.`f-id`
                                  AND `School`.`s-id` = `Faculty-School`.`s-id`
                            GROUP BY `Faculty-School`.`s-id`";
